{
   function myScript(thisObj) {
      ...
      function myScript_buildUI(thisObj) {
                ...
                myPanel.grp.buttonGroup.effectsGroup.aEffectGroup.EO.element_button.onClick = addElement;
                ...
                myPanel.grp.buttonGroup.expressionGroup.wiggle_button.onClick = setWiggle;
                myPanel.grp.buttonGroup.expressionGroup.bounce_button.onClick = setBounce;
                ...
                var renderButton = myPanel.grp.buttonGroup.settigsGroup.addToRender_button;
                renderButton.size = ["150","50"];
                renderButton.graphics.PenType.SOLID_COLOR, [0.7, 0.7, 0.7];
